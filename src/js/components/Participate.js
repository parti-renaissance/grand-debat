			...
			<div className="participate__grid">
				<div>
					<p className="muted">
						...
						d'événement physiques qui seront organisés partout en France par les équipes LaREM : <a href="https://en-marche.fr/evenements/categorie/grand-debat-atelier-idees" target="_blank">trouvez les
